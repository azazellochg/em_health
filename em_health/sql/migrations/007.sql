...
$$
  ...
  BEGIN
    ...
    IF current_version = 6 THEN
      ...
      -- 2. Misc & drop history tables for now
      ...
      -- 4. Create events.configurations
      ...
      -- 5. Create new empty enum tables
      ...
      -- 7. Re-creating events.parameters_history
      ...
      -- 8. Re-creating events.data_staging
